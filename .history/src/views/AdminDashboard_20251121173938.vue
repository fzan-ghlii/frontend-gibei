              ...
              <tbody class="divide-y divide-gray-100">
                ...
                <tr v-if="spmList.length === 0">
                  <td colspan="4" class="p-8 text-center text-gray-500">
                    ...
                    <span v-else>Belum ada kelas SPM yang dibuat.</span>
                  </td>
                </tr>
              </tbody>
            </table>
...
// import { useAuthStore } from '../store/auth' // <-- DIKOMENTAR DULU: Penyebab Crash

const router = useRouter()
// const authStore = useAuthStore() // <-- DIKOMENTAR DULU
...
const handleLogout = () => {
  // authStore.logout() // <-- DIKOMENTAR DULU
...
const openSpmModal = (spm = null) => {
  if (spm) {
    ...
    // Koreksi timezone agar tampil benar di input
